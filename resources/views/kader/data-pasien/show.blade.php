...
@section('content')
    ...
    <div class="bg-white shadow rounded-lg p-6">
            ...
            <div>
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-lg font-medium text-gray-800">{{ \Carbon\Carbon::parse($pasien->tanggal_lahir)->age }} tahun</p>
                    </div>
                    <div>
        ...
        <div class="mt-6 flex space-x-4">
            <a href="{{ route('kader.dataPasien') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300">
                Kembali
            </a>
        </div>
    </div>
...
<div id="deleteModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50" style="display: none;">
