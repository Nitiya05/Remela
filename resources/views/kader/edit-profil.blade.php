...
<div class="container mx-auto p-4">
    <div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Edit Profil Kader</h2>
        ...
        <form action="{{ route('kader.profile.update') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" 
                       ...
                       value="{{ old('email', $kader->email) }}" required>
                @error('email')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="border-t pt-4 mt-6">
                ...
                <div class="mb-4 relative">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Diperlukan untuk verifikasi perubahan</p>
            ...
            <div class="flex justify-end space-x-4 mt-8">
                <a href="{{ route('kader.dashboard') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-6 rounded-lg transition duration-200">
                    Batal
                </a>
