...
<div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <button onclick="openModal()" 
                ...
                data-intro="Klik di sini untuk menambahkan riwayat rekam medis lansia." 
                data-step="9">
        ...
        <div class="relative w-full md:w-1/2">
            <input 
                ...
                data-intro="Anda dapat mencari rekam medis lansia berdasarkan nama pasien atau NIK." 
                data-step="10"
            >
            ...
            <table class="min-w-full divide-y divide-gray-200 text-base">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">{{ $record->tekanan_darah_sistolik }}/{{ $record->tekanan_darah_diastolik }}</td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="flex flex-col sm:flex-row gap-2">
                                ...
                                <button onclick="openDeleteModal('{{ route('rekam-medis-lansia.destroy', $record->id) }}')"
    ...
    <div id="modalTambahRiwayat" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden text-base">
            <div class="p-6">
                ...
                <div class="relative mb-4">
                    <input type="text" id="searchPasien" class="w-full p-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-600 text-base"
            ...
            <div class="p-6">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    <div class="flex justify-end gap-3">
                        <button type="button" onclick="closeDeleteModal()" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition text-sm">
                            Batal
                        </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            document.querySelectorAll('tbody tr').forEach(row => {
                ...
                row.style.display = (nama.includes(searchTerm) || nik.includes(searchTerm)) ? '' : 'none';
            });
        });
        ...
        if (searchPasien) {
            searchPasien.addEventListener('input', function() {
                ...
                document.querySelectorAll('#modalTambahRiwayat tbody tr').forEach(row => {
                    const nama = row.children[1].textContent.toLowerCase();
                    const nik = row.children[2].textContent.toLowerCase();
                    row.style.display = (nama.includes(filter) || nik.includes(filter)) ? '' : 'none';
                });
            });
        }
    });
