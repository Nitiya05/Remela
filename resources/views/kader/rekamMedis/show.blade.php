            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/2 bg-white p-6 shadow-md rounded-lg overflow-x-auto">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-6">
                        <form action="{{ route('rekam-medis-lansia.show', $pasien->id) }}" method="GET"
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        ...
                                        @if (auth()->user()->role == 'kader')
                                            <p class="mt-1">
                                                Anda dapat <a href="{{ route('kader.rekamMedis') }}"
                                                    class="text-blue-600 underline hover:text-blue-800">menambahkan data
                                                    rekam medis</a> terlebih dahulu.
                                            </p>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-blue-700">
                                                ...
                                                @if (auth()->user()->role == 'kader')
                                                    <p class="mt-1">
                                                        Anda dapat <a href="{{ route('kader.rekamMedis') }}"
                                                            class="text-blue-600 underline hover:text-blue-800">menambahkan
                                                            data rekam medis</a> terlebih dahulu.
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (cetakPDF) {
                cetakPDF.addEventListener('click', function(e) {
                    ...
                    let url = "{{ route('rekam-medis.printpdf', ['id' => $pasien->id ?? 0]) }}";
