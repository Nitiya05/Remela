...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <!-- Sidebar -->
        <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-cyan-800 p-5 transform sidebar-transition -translate-x-full md:translate-x-0 z-50 overflow-y-auto scrollbar-hide"
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('admin.manajemenpengguna') }}" 
                    ...
                    data-intro="Menu Manajemen Pengguna. Klik untuk mengelola pengguna."
                    data-step="3">
