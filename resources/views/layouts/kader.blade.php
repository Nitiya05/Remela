...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside id="sidebar" 
            class="fixed top-0 left-0 h-full w-64 bg-cyan-800 p-5 transform transition-all duration-300 ease-in-out md:translate-x-0 z-50 overflow-y-auto scrollbar-hide"
            ...
            <nav class="mt-8" data-intro="Menu navigasi untuk berpindah halaman." data-step="2">
                ...
                <a href="{{ route('logout') }}" 
                    ...
                    data-intro="Klik di sini untuk keluar dari akun." data-step="8">
        ...
        <!-- Main Content -->
        <main id="main-content" class="flex-1 p-6 ml-64 transition-all duration-300 ease-in-out  overflow-y-auto  relative mb-20">
        ...
        <!-- Footer -->
        <footer id="footer" class="bg-[#eaf0f7] p-4 pl-64 pr-6 text-gray font-semibold shadow-md fixed bottom-0 w-full transition-all duration-300 ease-in-out">
